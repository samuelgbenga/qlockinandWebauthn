...
export const LatecomerReport = ({onOpen, data}) => {
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      
      <div className="flex justify-between items-center mb-4">
        <p className="text-gray-700 font-semibold text-lg">
          1-30 June 2023 - <span className="text-gray-500">Clock in by 8:30 AM, clock out at 5:00 PM</span>
        </p>
        <div className="flex space-x-3">
          ...
          <button className="bg-purple-500 text-white rounded px-4 py-2" onClick={onOpen}>+ Add Employees</button>
        </div>
      </div>
        ...
        <table className="min-w-full bg-white shadow-md rounded-lg">
          <thead className="bg-gray-200">
            <tr>
              ...
              <th className="px-4 py-2 text-left">Latecomer Rate (%)</th>
            </tr>
          </thead>
          <tbody>
